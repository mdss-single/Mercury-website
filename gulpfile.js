//yarn add gulp gulp-watch gulp-uglify gulp-stylus gulp-sourcemaps gulp-rigger gulp-plumber gulp-clean-css gulp-concat gulp-autoprefixer browser-sync
...
gulp.task('default', gulp.parallel('build', 'browserSync', 'watch'));